class Conexion:
    def __init__(self, tipo:int, distancia:int , origen: int, destino: int, modo:int, vel_max=None, peso_max=None, calado_max=None):
        #id si o no
        self.tipo=tipo
    ...
    def __str__(self): #no tiene id
        return (f"Conexion(tipo={self.tipo}, distancia={self.distancia}km, origen={self.origen}, destino={self.destino}, modo={self.modo}, vel_max={self.vel_max}, peso_max={self.peso_max}, calado_max={self.calado_max}, tasa={self.tasa})")